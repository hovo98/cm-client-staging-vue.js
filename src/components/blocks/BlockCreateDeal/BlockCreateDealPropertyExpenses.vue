    ...
    <ValidationObserver ref="propExpensesForm">
      ...
      <div class="form-highlight">
        <div class="form-split">
          ...
          <template v-if="propertyType === 'OWNER_OCCUPIED' || ifExisting === 'OWNER_OCCUPIED'">
          ...
          <template v-if="loan_type === 'CONSTRUCTION' || propertyType === 'INVESTMENT' || ifExisting === 'INVESTMENT'">
            ...
            <!-- Management -->
            <h4 class="title-extra-small form-split__title js-error-message">Management*</h4>
            <div class="input-holder form-split__input-holder form-split__input-holder--align-top">
              <div class="form-split__input-holder-col error-message-holder">
                <label class="radio-btn radio-btn--inline">
                  <input
                    v-model="management"
                    type="radio"
              ...
              <div class="form-split__input-holder-col">
                ...
                >  
                  ...
                  <div class="input-holder--with-placeholder error-message-holder">
                    <input
          ...
          </div><!-- End of Mutual fields for all PROPERTY TYPES -->
...
<script lang="ts">
    ...
    import { formatNumber, errorScroll, stringToNumber } from '@/config/util'
